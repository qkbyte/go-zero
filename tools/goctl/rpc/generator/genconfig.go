...
import (
	...
	conf "github.com/qkbyte/go-zero/tools/goctl/config"
	"github.com/qkbyte/go-zero/tools/goctl/rpc/parser"
...
// see https://github.com/qkbyte/go-zero/tree/master/tools/goctl/config/config.go
