...
import (
	...
	"github.com/qkbyte/go-zero/tools/goctl/api"
	"github.com/qkbyte/go-zero/tools/goctl/bug"
	"github.com/qkbyte/go-zero/tools/goctl/docker"
	"github.com/qkbyte/go-zero/tools/goctl/env"
	"github.com/qkbyte/go-zero/tools/goctl/internal/version"
	"github.com/qkbyte/go-zero/tools/goctl/kube"
	"github.com/qkbyte/go-zero/tools/goctl/migrate"
	"github.com/qkbyte/go-zero/tools/goctl/model"
	"github.com/qkbyte/go-zero/tools/goctl/quickstart"
	"github.com/qkbyte/go-zero/tools/goctl/rpc"
	"github.com/qkbyte/go-zero/tools/goctl/tpl"
	"github.com/qkbyte/go-zero/tools/goctl/upgrade"
...
var (
	...
	rootCmd = &cobra.Command{
		...
		Long: "A cli tool to generate api, zrpc, model code\n\n" +
			"GitHub: https://github.com/qkbyte/go-zero\n" +
