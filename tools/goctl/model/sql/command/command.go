...
import (
	...
	"github.com/qkbyte/go-zero/core/stores/postgres"
	"github.com/qkbyte/go-zero/core/stores/sqlx"
	"github.com/qkbyte/go-zero/tools/goctl/config"
	"github.com/qkbyte/go-zero/tools/goctl/model/sql/command/migrationnotes"
	"github.com/qkbyte/go-zero/tools/goctl/model/sql/gen"
	"github.com/qkbyte/go-zero/tools/goctl/model/sql/model"
	"github.com/qkbyte/go-zero/tools/goctl/model/sql/util"
	file "github.com/qkbyte/go-zero/tools/goctl/util"
	"github.com/qkbyte/go-zero/tools/goctl/util/console"
